...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='user2@example.com', password='test2')
    ...
    def test_create_recipe_with_new_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Thai Prawn'}, {'name': 'salt'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'ingredients': [{'name': 'Indian Prawn'}, {'name': 'Salt'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipes = Recipe.objects.filter(user=self.user)
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assigning an exising ingredient"""
    ...
    def test_filter_by_ingredients(self):
        ...
        ingredient1 = Ingredient.objects.create(user=self.user, name='FCheese')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as tempImgFile:
            img = Image.new('RGB', (10, 10))
            img.save(tempImgFile, format='JPEG')
            tempImgFile.seek(0)
            payload = {'image': tempImgFile}
